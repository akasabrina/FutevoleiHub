...
try {
  // Buscar a senha atual do professor
  ...
  // Verifica se nova senha foi fornecida e processa
  if (!empty($nova_senha)) {
  ...
  echo "<script>alert('Erro ao atualizar o professor: " . $e->getMessage() . "'); window.history.back();</script>";
  exit;
}
