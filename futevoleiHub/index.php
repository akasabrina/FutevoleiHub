...
<body>
  ...
  <nav class="navbar fixed-top shadow-sm bg-white">
    <div class="container d-flex justify-content-between align-items-center">
      <a class="navbar-brand fw-bold" href="#"> Futevôlei Eduba </a>
        ...
        <div class="container">
          ...
          <div class="accordion" id="accordionArenas">
            <?php if (count($arenas) > 0): ?>
              <?php foreach ($arenas as $index => $arena): ?>
                <?php
                $arenaHeadingId = 'arenaHeading' . $arena['id_arena'];
                $arenaCollapseId = 'arenaCollapse' . $arena['id_arena'];
                ?>
                <div class="accordion-item mb-3">
                  <h2 class="accordion-header" id="<?= $arenaHeadingId ?>">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      data-bs-target="#<?= $arenaCollapseId ?>" aria-expanded="false" aria-controls="<?= $arenaCollapseId ?>">
                      <?= htmlspecialchars($arena['nome_arena']) ?>
                    </button>
                  </h2>
                  <div id="<?= $arenaCollapseId ?>" class="accordion-collapse collapse"
                    aria-labelledby="<?= $arenaHeadingId ?>" data-bs-parent="#accordionArenas">
